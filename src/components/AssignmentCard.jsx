...
//   return (
//     <div className="bg-white max-w-[1600px] mx-auto rounded-2xl shadow-md p-6 flex flex-col md:flex-row gap-6 hover:shadow-lg transition-all duration-300">
//       <img
      ...
      <div className="p-6 flex flex-col justify-between h-full flex-grow">
        <div>
          ...
          <div className="flex items-center justify-between text-sm text-gray-700 mb-4">
            ...
            <span className={`px-3 py-1 rounded-full font-semibold text-xs ${getDifficultyStyle(difficulty)}`}>
              {difficulty || "Unknown"}
            </span>
          </div>
        </div>
